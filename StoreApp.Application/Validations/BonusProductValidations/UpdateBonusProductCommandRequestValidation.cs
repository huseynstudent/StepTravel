...
{
    public class UpdateBonusProductCommandRequestValidation : AbstractValidator<UpdateBonusProductCommandRequest>
    {
        public UpdateBonusProductCommandRequestValidation()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("The bonus product ID must be greater than zero !")
                .NotEmpty().WithMessage("The bonus product ID cannot be empty !");
